...
// let numeroIngresado = parseInt(prompt(`Ingrese un numero o ingrese "0" para finalizar`))
...
//     }
//     numeroIngresado = parseInt(prompt(`Ingrese un numero o ingrese "0" para finalizar`))
// }

// console.log(`La suma de los numeros pares es ${sumaNumerosPares}`)
// console.log(`La suma de los numeros impares es ${sumaNumerosImpares}`)

// let numerosAleatorios = [79, 1, 5, 35, 50, 108, 49, 27, 80, 78]

// let numeroMaximo = numerosAleatorios[0]
